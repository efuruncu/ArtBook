package com.eliffuruncu.artbook;
...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        artNameText=(EditText)findViewById(R.id.artNameText);
        painterNameText=(EditText)findViewById(R.id.painterNameText);
    ...
    {
        //ContextCompact -> API 23 den öncesi ve sonrasındaki değişikleri uyumlu bir şekilde çalıştıran
       //izin verilmediyse ne yapıcaz??
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if(requestCode == 2 && resultCode == RESULT_OK && data != null)
        {
            ...
            if(Build.VERSION.SDK_INT >=28)
            {
                ...
                //API 28 den öncesi için getBitmap()
                try {
